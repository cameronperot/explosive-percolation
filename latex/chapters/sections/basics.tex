...
Graph like structures are a fundamental part of nature, therefore the study of them is of great importance in a number of different fields.
...
To study such things we need a framework in which to do so; this is where percolation theory enters the picture.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=350pt]{images/2d_site_clusters.png}
