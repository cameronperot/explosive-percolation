...
A Julia package for simulating percolation via graph evolution on networks and lattices.
Check the project out on [GitHub](https://github.com/cameronperot/explosive-percolation)!
